...
export default function SignInScreen() {
  ...
  return (
    ...
    >
      {/* decorative element */}
      <View className="absolute -left-16 top-12 h-56 w-56 rounded-full bg-secondary/40 dark:bg-background/40" />
      <View className="absolute right-[-74px] top-40 h-72 w-72 rounded-full bg-secondary/70 dark:bg-background/35" />
      ...
      <View className="px-6 pt-4">
        ...
        <Text className="mt-1 text-center text-[15px] text-primary-foreground/80 dark:text-foreground/75">
          Plan smarter. Shop happier.
        </Text>
      </View>

      <View className="mt-6 mx-6 rounded-[30px] border border-white/20 bg-white/10 p-3">
        <Image
